...
module SemiStatic
  module SiteHelper
    ...
    def squeeze(entry)
      ...
      "<a class='squeeze' rel='nofollow' onclick='semiStaticAJAX(\"#{squeeze_path(s, :format => :js, :popup => true)}\")\; return false;' href='#{squeeze_path(s)}'>#{simple_format(s.teaser)}</a>".html_safe
    end
