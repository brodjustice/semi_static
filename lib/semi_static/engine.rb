...
module SemiStatic
  class Engine < ::Rails::Engine
    ...
    #
    config.assets.precompile += %w( favicon.ico home.css font.css semi_static_application.css semi_static_full.css semi_static_dashboard.css user_dashboard.css semi-static.js semi_static_application.js semi_static_dashboard.js semi_static_dashboard_raw_rails.js semi_static_jquery.js home_theme.js theme.js user_dashboard.js entry_form.js bootstrap.js bootstrap-dashboard.js jquerytablesorter.min.js table-dashboard.css )
